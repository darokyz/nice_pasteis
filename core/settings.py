...
# Localmente a aplicação continua simples, com SQLite. No Render, DATABASE_URL
# (fornecida pelo Postgres gerenciado) ativa PostgreSQL e mantém os dados fora
# do filesystem efêmero do Web Service gratuito.
